...
-----------------------------------------------------------------------------------
Computing strategy expected value ...Total expected value using this strategy if double, split and surrender are allowed is: 0.996722
(you win a total of 0.996722 every time you do an initial bet of 1)
-----------------------------------------------------------------------------------
```
