...
8-8	Sp	Sp	Sp	Sp	Sp	Sp	Sp	Sp	Sp	U-Sp	
...
-----------------------------------------------------------------------------------
Computing strategy expected value ...Total expected value using this strategy if double, split and surrender are allowed is: 1.006536
(you win a total of 1.006536 every time you do an initial bet of 1)
-----------------------------------------------------------------------------------
```
