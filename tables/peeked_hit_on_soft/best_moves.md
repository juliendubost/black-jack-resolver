...
-----------------------------------------------------------------------------------
Computing strategy expected value ...Total expected value using this strategy if double, split and surrender are allowed is: 1.010486
(you win a total of 1.010486 every time you do an initial bet of 1)
-----------------------------------------------------------------------------------
```
