...
-----------------------------------------------------------------------------------
Computing strategy expected value ...Total expected value using this strategy if double, split and surrender are allowed is: 1.008584
(you win a total of 1.008584 every time you do an initial bet of 1)
-----------------------------------------------------------------------------------
```
